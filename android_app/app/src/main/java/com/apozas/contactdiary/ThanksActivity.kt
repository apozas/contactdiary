...
class ThanksActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hindi = findViewById<TextView>(R.id.thanks_hindi)
        hindi.movementMethod = LinkMovementMethod.getInstance()
        ...
        val japanese = findViewById<TextView>(R.id.thanks_japanese)
        japanese.movementMethod = LinkMovementMethod.getInstance()
        ...
        val russian = findViewById<TextView>(R.id.thanks_russian)
        russian.movementMethod = LinkMovementMethod.getInstance()
        ...
        val ukrainian = findViewById<TextView>(R.id.thanks_ukrainian)
        ukrainian.movementMethod = LinkMovementMethod.getInstance()
    }
}