...
//          Create new row
            val values = ContentValues().apply {
                ...
                put(ContactDatabase.ContactDatabase.FeedEntry.NAME_COLUMN, eventname_edit.getText().toString())
                put(ContactDatabase.ContactDatabase.FeedEntry.PLACE_COLUMN, eventplace_edit.getText().toString())
                put(ContactDatabase.ContactDatabase.FeedEntry.DATETIME_COLUMN, cal.timeInMillis)
                put(ContactDatabase.ContactDatabase.FeedEntry.PHONE_COLUMN, eventphone_edit.getText().toString())
                put(ContactDatabase.ContactDatabase.FeedEntry.COMPANIONS_COLUMN, eventpeople_edit.getText().toString())
